...
meet_urlpatterns = [
    path('', meet_views.MeetingListView.as_view(), name='index'),
    path('create/', meet_views.MeetingCreateView.as_view(), name='create'),
]
...
urlpatterns = [
    ...
    path('<int:club_id>/meetings/', include(meet_urlpatterns, namespace='meetings'))
]