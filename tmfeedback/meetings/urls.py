...
eval_urlpatterns = [
    path('create/', eval_views.EvalCreateView.as_view(), name='create'),
]
...
perf_urlpatterns = [
    ...
    path('<int:perf_pk>/evals/', include(eval_urlpatterns, namespace='evals')),
]
...
urlpatterns = [
    ...
    path('<int:meeting_pk>/performances/', include(perf_urlpatterns, namespace='performances')),
]
